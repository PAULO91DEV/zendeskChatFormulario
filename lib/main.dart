...
const ZendeskAccountKey = '294780ac-451f-4aca-b17c-292905a7febf';
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initZendesk() async {
    zendesk
        .init(ZendeskAccountKey, department: 'Department Name', appName: 'My Example App')
        .then((r) {
      print('init finished');
    }).catchError((e) {
